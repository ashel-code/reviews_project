...
URL = "https://yandex.ru/maps/213/moscow/?ll=37.589146%2C55.731010&mode=poi&poi%5Bpoint%5D=37.58914" \
      "6%2C55.731010&poi%5Buri%5D=ymapsbm1%3A%2F%2Forg%3Foid%3D153977379747&tab=reviews&z=17.32"
...
class Prints:
    ...
    @staticmethod
    def print_all(all_reviews, all_dates, all_ratings):
        for i in range(len(reviews)):
            print(i + 1, " - ", all_dates[i].text, " - ", all_ratings[i], " - ", all_reviews[i].text)
...
# TODO: check if file already exist`s, otherwise execute the line right down
# Setup.get_source_html(URL)    DO IF IT IS THE FIRST RUN OF THE PROGRAM
...
print("-------------------------------------------------------------------------")
Prints.print_all(reviews, review_dates, rating)
